...
trait RichImpl extends BooleansImpl with IntsImpl with DoublesImpl with FloatsImpl with LongsImpl with UnitsImpl with ArraysImpl with FunctionsExp with IfThenElseExp with EqualsImpl with ListsImpl with MatrixsImpl with IndexedSeqsImpl with RichExp

trait RichOptImpl extends BooleansImpl with IntsOptImpl with DoublesOptImpl with FloatsOptImpl with LongsOptImpl with UnitsImpl with ArraysOptImpl with FunctionsExp with IfThenElseExpOpt with EqualsOptImpl with ListsOptImpl with MatrixsOptImpl with IndexedSeqsOptImpl with RichExp
